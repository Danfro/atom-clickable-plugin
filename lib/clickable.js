  ...
  return class ClickableProvider extends EventEmitter {
    ...
    createMenu() {
      if (this.clickableFile) {
          ...
          // this part seems to make atom run clickable.yaml on startup
          // if that is not formatted to strict yaml code, the plugin will break
          // and be not available
          // since I don't know what this part is used for, I comment it out
